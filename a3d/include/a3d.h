...
enum DESCRIPTOR_TYPE
{
    ...
    DESCRIPTOR_TYPE_SRV_B   = 1,        //!< シェーダリソースビュー(バッファ用)です.
    DESCRIPTOR_TYPE_SRV_T   = 2,        //!< シェーダリソースビュー(テクスチャ用)です.
    DESCRIPTOR_TYPE_UAV_B   = 3,        //!< アンオーダードアクセスビュー(バッファ用)です.
    DESCRIPTOR_TYPE_UAV_T   = 4,        //!< アンオーダードアクセスビュー(テクスチャ用)です.
    DESCRIPTOR_TYPE_SMP     = 5,        //!< サンプラーです.
    DESCRIPTOR_TYPE_RTV     = 6,        //!< カラーターゲットビューです.
    DESCRIPTOR_TYPE_DSV     = 7,        //!< 深度ステンシルビューです.
};
...
struct A3D_API IReference
{
    ...
    //---------------------------------------------------------------------------------------------
    virtual void A3D_APIENTRY SetName(const char* name) = 0;
    ...
    //! @return     デバッグ名を返却します.
    //---------------------------------------------------------------------------------------------
    virtual const char* A3D_APIENTRY GetName() const = 0;
};
