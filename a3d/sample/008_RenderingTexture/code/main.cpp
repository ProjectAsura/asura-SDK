...
bool InitA3D()
{
    ...
    {
    #if SAMPLE_IS_VULKAN
        const auto vsFilePath = "../res/glsl/colorVS.spv";
        const auto psFilePath = "../res/glsl/colorPS.spv";
    #else
        const auto vsFilePath = "../res/hlsl/colorVS.cso";
        const auto psFilePath = "../res/hlsl/colorPS.cso";
    #endif
