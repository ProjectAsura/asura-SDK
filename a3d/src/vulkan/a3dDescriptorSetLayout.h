...
public:
    ...
    //---------------------------------------------------------------------------------------------
    //! @brief      プッシュ定数シェーダステージフラグを取得します.
    //! 
    //! @return     プッシュ定数シェーダステージフラグを返却します.
    //---------------------------------------------------------------------------------------------
    VkShaderStageFlags GetPushConstantFlags() const;
...
private:
    ...
    VkShaderStageFlags      m_PushConstantFlags;    //!< プッシュ定数シェーダステージフラグです.
