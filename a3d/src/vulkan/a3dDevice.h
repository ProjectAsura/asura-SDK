...
public:
    ...
    //---------------------------------------------------------------------------------------------
    //! @brief      フレームキャプチャー中かどうか?
    //! 
    //! @retval true    フレームキャプチャー中です.
    //! @retval false   フレーム非キャプチャー中です.
    //---------------------------------------------------------------------------------------------
    bool IsFrameCapturing();

    //---------------------------------------------------------------------------------------------
    //! @brief      フレームキャプチャーを開始します.
    //! 
    //! @param[in]      windowHandle        ウィンドウハンドル.
    //---------------------------------------------------------------------------------------------
    void StartFrameCapture(void* windowHandle);

    //---------------------------------------------------------------------------------------------
    //! @brief      フレームキャプチャーを終了します.
    //! 
    //! @param[in]      windowHandle        ウィンドウハンドル.
    //---------------------------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------------------------
    //! @brief      デフォルトサンプラーを取得します.
    //! 
    //! @return     デフォルトサンプラーを返却します.
    //---------------------------------------------------------------------------------------------
