...
//-----------------------------------------------------------------------------
//! @brief      エントリーポイント名を見つけます.
//!
//! @param[in]      pBinary     シェーダバイナリ.
//! @param[in]      size        シャーだバイナリサイズ.
//! @return     エントリーポイント名の先頭ポインタを返却します.
//!             エントリーポイントが見つからない場合は nullptr を返却します.
//-----------------------------------------------------------------------------
const char* FindEntryPoint(const void* pBinary, size_t size);
