...
///////////////////////////////////////////////////////////////////////////////////////////////////
class ConstantBufferView : public IConstantBufferView, public BaseAllocator
{
    //=============================================================================================
...
public:
    ...
    //! @return     構成設定を返却します.
    //---------------------------------------------------------------------------------------------
    ConstantBufferViewDesc A3D_APIENTRY GetDesc() const override;
...
private:
    ...
    ConstantBufferViewDesc  m_Desc;         //!< 構成設定です.
    ...
    //! @brief      コンストラクタです.
    //---------------------------------------------------------------------------------------------
    A3D_APIENTRY ConstantBufferView();
    ...
    //! @retval false   初期化に失敗.
    //---------------------------------------------------------------------------------------------
    bool A3D_APIENTRY Init(IDevice* pDevice, IBuffer* pBuffer, const ConstantBufferViewDesc* pDesc);
    ...
    void operator =     (const ConstantBufferView&) = delete;
};
