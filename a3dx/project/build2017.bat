...
call :CLEAN "d3d11/VS2017/a3dx.sln"
call :CLEAN "d3d12/VS2017/a3dx.sln"
call :CLEAN "vulkan/VS2017/a3dx.sln"

call :BUILD "d3d11/VS2017/a3dx.sln"
call :BUILD "d3d12/VS2017/a3dx.sln"
call :BUILD "vulkan/VS2017/a3dx.sln"
