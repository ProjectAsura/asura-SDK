...
{
    return Vector2(
        fnd::Clamp( value.x, a.x, b.x ),
        fnd::Clamp( value.y, a.y, b.y )
    );
}
...
{
    result.x = fnd::Clamp( value.x, a.x, b.x );
    result.y = fnd::Clamp( value.y, a.y, b.y );
}
...
{
    return Vector2(
        fnd::Saturate( value.x ),
        fnd::Saturate( value.y )
    );
}
...
{
    result.x = fnd::Saturate( value.x );
    result.y = fnd::Saturate( value.y );
}
...
{
    result.x = fnd::Min( a.x, b.x );
    result.y = fnd::Min( a.y, b.y );
}
...
{
    result.x = fnd::Max( a.x, b.x );
    result.y = fnd::Max( a.y, b.y );
}
...
{
    auto s = fnd::Clamp( amount, 0.0f, 1.0f );
...
void Vector3::Clamp( const Vector3 &value, const Vector3 &a, const Vector3 &b, Vector3 &result )
{
    result.x = fnd::Clamp( value.x, a.x, b.x );
    result.y = fnd::Clamp( value.y, a.y, b.y );
    result.z = fnd::Clamp( value.z, a.z, b.z );
}
...
void Vector4::Clamp( const Vector4 &value, const Vector4 &a, const Vector4 &b, Vector4 &result )
{
    ...
    result.y = fnd::Clamp( value.y, a.y, b.y );
    result.z = fnd::Clamp( value.z, a.z, b.z );
    result.w = fnd::Clamp( value.w, a.w, b.w );
}
